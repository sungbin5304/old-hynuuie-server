...
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_ANIM_DURATION
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_CORNER_RADIUS
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_ICON_MARGIN
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_ICON_SIZE
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_INDICATOR_COLOR
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_ITEM_PADDING
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_SIDE_MARGIN
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_TEXT_SIZE
import com.sungbin.hyunnie.server.widget.bottombar.Constants.DEFAULT_TINT
import com.sungbin.hyunnie.server.widget.bottombar.Constants.OPAQUE
import com.sungbin.hyunnie.server.widget.bottombar.Constants.TRANSPARENT
import com.sungbin.hyunnie.server.widget.bottombar.Constants.WHITE_COLOR_HEX
...
class SmoothBottomBar : View {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        if(isThemeChange){
            itemIconTint = accent
            itemIconTintActive = primaryDark
            barIndicatorColor = accent
